...
const ROOT_FOLDER_ID = process.env.DRIVE_ROOT_FOLDER_ID || process.env.GOOGLE_DRIVE_FOLDER_ID || '1DTSwGkV4_jniit6tv9svFZba1oa7DuUT';
...
function getStoredTokenRecord() {
  ...
  const refreshToken = process.env.GOOGLE_REFRESH_TOKEN || process.env.GOOGLE_DRIVE_REFRESH_TOKEN || process.env.DRIVE_REFRESH_TOKEN;
  if (refreshToken) {
